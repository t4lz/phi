// Adapted from https://github.com/TheAlgorithms/C-Plus-Plus/blob/master/numerical_methods/inverse_fast_fourier_transform.cpp
/**
 * @file
...
static int test() {
    ...
    for (uint8_t i = 0; i < n1; i++) {
        if (!((r1[i].real() - o1[i].real() < 0.000000000001) &&
               (r1[i].imag() - o1[i].imag() <
                0.000000000001)))
            return 1;
    }
    ...
    for (uint8_t i = 0; i < n2; i++) {
        if (!((r2[i].real() - o2[i].real() < 0.000000000001) &&
               (r2[i].imag() - o2[i].imag() <
                0.000000000001)))
                return 2;
    }
